...
def database_table_with_system_name_endpoint(_dt_system_name, _tb_system_name):
    return jsonify(endpoint.database_table_system_name.endpoint(_dt_system_name, _tb_system_name))
