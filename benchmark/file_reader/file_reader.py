...
print(comparateur('prenom9', 'prenom50') + ' expected : prenom50')
print(comparateur('prenom50', 'prenom9') + ' expected : prenom50')
print(comparateur('prenom50', 'prenome9') + ' expected : prenome9')
print(comparateur('prenom5', 'prenom9a') + ' expected : prenom9a')
print(comparateur('prenom50b', 'prenom90a') + ' expected : prenom90a')
print(comparateur('prenom90b', 'prenom90a') + ' expected : prenom90b')
print(comparateur('prenom987', 'prenom997') + ' expected : prenom997')
print(comparateur('ABC-999-DEF', 'ABC-1000-DEF') + ' expected : ABC-1000-DEF')
print(comparateur('A', '9') + ' expected : A')
print()
